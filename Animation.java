...
public class Animation {
    ...
    private boolean scorpionOnLeft;
    private boolean subZeroOnLeft;
    ...
    public Animation(Scorpion scorpion, SubZero subZero) {
        ...
        this.animOffsetX = 57;
        this.animOffsetY = 45;
        if(scorpion.getPositionX() < subZero.getPositionX()){
            scorpionOnLeft = true;
            subZeroOnLeft = false;
        }else{
            scorpionOnLeft = false;
            subZeroOnLeft = true;
        }

        // SCORPION ATTACKS as new handle animation
        this.scorpionPunch = new HandleAnimation(scorpionSheet, 28, 579, 234, 221, 5, 3, false, scorpionOnLeft);
        this.scorpionUppercut = new HandleAnimation(scorpionSheet, 1439, 2566, 234, 221, 5, 4, false, scorpionOnLeft);
        this.scorpionHighkick = new HandleAnimation(scorpionSheet, 28, 1570, 234, 221, 5, 5, false, scorpionOnLeft);
        this.scorpionJumpkick = new HandleAnimation(scorpionSheet, 3779, 3565, 234, 221, 5, 3, false, scorpionOnLeft);
        this.scorpionSweep = new HandleAnimation(scorpionSheet, 1904, 1570, 234, 221, 8, 3, false, scorpionOnLeft);
        this.scorpionIdle = new HandleAnimation(scorpionSheet, 28, 59, 234, 221, 7, 4, true, scorpionOnLeft);
        this.scorpionWalk = new HandleAnimation(scorpionSheet, 1905, 59, 234, 221, 9, 4, true, scorpionOnLeft);
        this.scorpionJump = new HandleAnimation(scorpionSheet, 499, 3562, 234, 221, 7, 4, false, scorpionOnLeft);
        this.scorpionSpecialFirst = new HandleAnimation(scorpionSheet, 28, 6644, 234, 221, 3, 1, false, scorpionOnLeft);
        this.scorpionSpecialLast = new HandleAnimation(scorpionSheet, 730, 6644, 234, 221, 4, 1, false, scorpionOnLeft);
        this.scorpion = scorpion;
        this.scorpionIdle.start();

        // SUBZERO ATTACKS
        this.subzeroPunch = new HandleAnimation(subzeroSheet, 28, 579, 234, 221, 5, 3, false, subZeroOnLeft);
        this.subzeroUppercut = new HandleAnimation(subzeroSheet, 1439, 2566, 234, 221, 5, 4, false, subZeroOnLeft);
        this.subzeroHighkick = new HandleAnimation(subzeroSheet, 28, 1570, 234, 221, 5, 5, false, subZeroOnLeft);
        this.subzeroJumpkick = new HandleAnimation(subzeroSheet, 3779, 3565, 234, 221, 5, 3, false, subZeroOnLeft);
        this.subzeroSweep = new HandleAnimation(subzeroSheet, 1904, 1570, 234, 221, 8, 3, false, subZeroOnLeft);
        this.subzeroIdle = new HandleAnimation(subzeroSheet, 28, 59, 234, 221, 12, 4, true, subZeroOnLeft);
        this.subzeroWalk = new HandleAnimation(subzeroSheet, 3075, 59, 234, 221, 9, 3, true, subZeroOnLeft);
        this.subzeroJump = new HandleAnimation(subzeroSheet, 499, 3562, 234, 221, 7, 4, false, subZeroOnLeft);
        this.subzeroSpecial = new HandleAnimation(subzeroSheet, 28, 6644, 283, 215, 10, 4, false, subZeroOnLeft);
